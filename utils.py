...
def thumbnail(filename, size=(50, 50), output_filename=None):
    # https://djangosnippets.org/snippets/20/
...
def calcMenuNumber(tapNumber, n=13):
    '''
    tapNumber is the number of the tap
    n is the first number of the second row
    '''
    menuNumber = 0
    if tapNumber >= n:
        tapNumber = tapNumber - (n - 1)
    return menuNumber